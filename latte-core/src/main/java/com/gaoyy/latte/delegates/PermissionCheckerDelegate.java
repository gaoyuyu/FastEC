...
import com.gaoyy.latte.ui.camera.CameraImageBean;
import com.gaoyy.latte.ui.camera.LatteCamera;
import com.gaoyy.latte.ui.camera.RequestCodes;
        ...
        if (resultCode == RESULT_OK)
        {
            switch (requestCode)
            {
                case RequestCodes.TAKE_PHOTO:
                    ...
                    LatteLogger.d(resultUri);
                    //第一个参数原始路径，第二个参数是剪裁后存储的路径，这里相同直接覆盖
